...
# 36 "merge.c"
int
merge_init_inner_10(task_t *task, void* aux)
{
 link_t *link;
 array_int_t *tmp;
...
int
merge_start_inner_10(task_t *task)
{
 link_t *link;
 int j;
...
int
merge_run_inner_10(task_t *task)
{
...
int
merge_kill_inner_10(task_t *task)
{
...
int
merge_destroy_inner_10(task_t *task)
{
