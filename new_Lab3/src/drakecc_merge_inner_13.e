...
# 36 "merge.c"
int
merge_init_inner_13(task_t *task, void* aux)
{
 link_t *link;
 array_int_t *tmp;
...
int
merge_start_inner_13(task_t *task)
{
 link_t *link;
 int j;
...
int
merge_run_inner_13(task_t *task)
{
...
# 127 "merge.c"
 if(parent_size>0)
 {
  ...
  }else if(left_size == 0 && drake_task_killed(left_link->prod) )
  {
  ...
  }else if(right_size == 0 && drake_task_killed(right_link->prod) )
  {
   int limite = left_size<parent_size ? left_size : parent_size;
   memcpy(parent,left,sizeof(int)*limite);
   parent_pushed += limite;
...
int
merge_kill_inner_13(task_t *task)
{
...
int
merge_destroy_inner_13(task_t *task)
{
